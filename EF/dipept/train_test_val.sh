...
mmml fix-and-split --efd out/*ef1*npz --output-dir out/splits1 --atomic-ref pbe0/def2-tzvp #--flip-forces 
mmml fix-and-split --efd out/*ef*npz --output-dir out/splits01 --atomic-ref pbe0/def2-tzvp #--flip-forces 
