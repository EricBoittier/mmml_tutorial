...
PHYSNET_TRAIN_NPZ=./out/splits/dcm/energies_forces_dipoles_train.npz
PHYSNET_VALID_NPZ=./out/splits/dcm/energies_forces_dipoles_valid.npz
PHYSNET_NATOMS=20
PHYSNET_BATCH=16
...
python "$PHYSNET_TRAINER" \
  ...
  --zbl --restart "/mmhome/boittier/home/mmml_tutorial/acodcm/ckpts/dcm1-c137fb42-1f65-4748-880b-8f8184a20f70" \
  --name "$PHYSNET_NAME" \
