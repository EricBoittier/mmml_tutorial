...
echo "Command: loop over out/xyz_split/*.sampled.npz with mmml pyscf-evaluate --esp"
...
echo "Output: out/xyz_split/*.sampled.npz.eval.npz (R, Z, N, E, F, Dxyz, esp, esp_grid)"
