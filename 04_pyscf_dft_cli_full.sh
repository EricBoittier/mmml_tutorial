...
# Run from project root: bash examples/mmml_tutorial/04_pyscf_dft_cli_full.sh
...
uv run mmml pyscf-dft --mol examples/mmml_tutorial/water.xyz \
  ...
  --output examples/mmml_tutorial/out/04_results
echo "Output: examples/mmml_tutorial/out/04_results.npz and .h5"
