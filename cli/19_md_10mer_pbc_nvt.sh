...
echo "Command: mmml md-10mer --setup pbc_nvt --temperature \"$MD10MER_TEMP_K\" --n-molecules \"$MD10MER_N_MOLECULES\" --ps \"$MD10MER_PS\" --dt-fs \"$MD10MER_DT_FS\" --output-dir \"$MD10MER_OUT/pbc_nvt\""
